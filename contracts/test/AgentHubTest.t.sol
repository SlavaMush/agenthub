...
contract MockERC8004Registry {
    ...
    function register(address agent) external { registered[agent] = true; }
}
...
contract AgentHubTest is Test {
    ...
    function setUp() public {
        ...
        agentHub = new AgentHub(address(usdc), address(sibylToken), address(memoryNFT), address(serviceListing), address(0), address(0));
